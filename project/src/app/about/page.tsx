  ...
  return (
    <main className="min-h-screen bg-white text-pink-500 px-4 md:px-8 py-12 max-w-5xl mx-auto">
      ...
      <section className="mb-12 space-y-6">
        ...
        <p>
          Radio Béguin est une association constituée d’une équipe bénévole passionnée et s’entoure de nombreux humains de tous horizons : artistes résident-es, créateur-ices de contenu sonore...
        </p>
        <p>
