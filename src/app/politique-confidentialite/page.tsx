    ...
    <main className="max-w-4xl mx-auto px-4 md:px-8 py-12 text-pink-500 space-y-10">
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          dont le siège est situé 2B rue Louis Thevenent, 69004 Lyon, France. Vous pouvez contacter le délégué à la protection des données à l'adresse
